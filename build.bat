...
set commonCompilerFlags= -MD -nologo -Gm- -GR- -EHa- -O2 -Oi -arch:AVX -WX -W4 -WL -wd4100 -wd4201 -wd4189 -wd4505 -wd4127 -wd4238 -wd4324 -we4746 -FC -Z7 -Fm -D_DEBUG -DROOTD12INCLUDE
...
fxc /nologo /Zi /DLINE_SHADER_VS /E lineShaderVS /T vs_5_1 /Fo lineShaderVS.cso ..\code\shaders.hlsl
fxc /nologo /Zi /DLINE_SHADER_PS /E lineShaderPS /T ps_5_1 /Fo lineShaderPS.cso ..\code\shaders.hlsl
